...
import {SVG,callAPI,  _window } from 'douhub-ui-web-basic';
import { observer } from 'mobx-react-lite';
import { createListItem, deleteListItem, createList, retrieveList, retrieveListItems } from 'douhub-ui-realtime';
import { useRouter } from 'next/router';
import {  InputTextArea as Input, Checkbox } from 'douhub-ui-web';
import { isNonEmptyString, newGuid } from 'douhub-helper-util';
import { isFunction } from 'lodash';

const ChatInputPart = (props: Record<string, any>) => {
  ...
  const onSubmit = () => {
    ...
    callAPI(solution, `${solution.apis.chat}send-message`, { data: {id: messageId, entityName:'Message', entityType:'Chat', roomId, content: message } }, 'POST')
      .then((newMessage:any) => { 
  ...
  return (
    <div className="border-t border-gray-200 pt-2 mb-2 sm:mb-0 py-2 px-4">
      {ready && !sending && <div className="flex py-2 ">
        <Input autoSize={{ minRows: 1, maxRows: 6 }} 
...
ChatInputPart.displayName = 'Parts.ChatInputPart';
